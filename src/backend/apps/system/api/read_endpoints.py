...
@router.get("/readyz", response_model=ReadinessProbe, responses=system_error_responses(500))
...
@router.get("/health", response_model=ReadinessProbe, responses=system_error_responses(500))
